...
class APIServices{
    ...
    //function for fetch all adventure  places
    func fetchAllAdventurePlaces(completion: @escaping (Result<[AdventurePlace], APIError>) -> Void){
    ...
    //function for fetch  packages by ID
    func fetchAdventurePackages( by id:  String, completion: @escaping (Result<Packages, APIError>) -> Void){
        
        performRequest(
            endpoint: "packages/details/\(id)",
            method: .GET,
            responceType: Packages.self,
            completion: completion
        )
    ...
    //function for fetch user detail
    func fetchUser(completion: @escaping (Result<User, APIError>) -> Void){
        
        performRequest(
            endpoint: "users",
            method: .GET,
            responceType: User.self,
            completion: completion
        )
    }
    
    //function for update user detail
    func updateUser(userId: String, name: String, phone: String, completion: @escaping (Result<User, APIError>) -> Void){
    ...
    func changePassword(userId: String, newPassword: String, completion: @escaping (Result<User, APIError>) -> Void){
        ...
        performRequest(
            endpoint: "users/changepassword/\(userId)",
            method: .PUT,
            body: body,
            responceType: User.self,
            completion: completion
